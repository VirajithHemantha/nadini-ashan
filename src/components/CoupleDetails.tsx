    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8 relative z-10">
        ...
        >
          ...
          <Sparkles className="absolute top-8 left-0 w-8 h-8 text-brand-gold-deep animate-pulse drop-shadow-sm z-20" />
          <Sparkles className="absolute bottom-10 -right-4 w-6 h-6 text-brand-gold/60 animate-pulse delay-300 drop-shadow-sm z-20" />
        </motion.div>

        {/* Mobile divider between image and groom */}
        <div className="lg:hidden order-3 w-full flex justify-center py-4 opacity-50">
          <div className="w-1/2 h-px bg-gradient-to-r from-transparent via-brand-gold-deep/40 to-transparent" />
        </div>
